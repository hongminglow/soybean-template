...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconIcOutlineSearch: typeof import('~icons/ic/outline-search')['default']
...
declare global {
  ...
  const IconIcBaselinePlus: typeof import('~icons/ic/baseline-plus')['default']
  const IconIcOutlineRefresh: typeof import('~icons/ic/outline-refresh')['default']
  const IconIcOutlineSearch: typeof import('~icons/ic/outline-search')['default']
  ...
  const IconMaterialSymbolsArrowUpward: typeof import('~icons/material-symbols/arrow-upward')['default']
  const IconMaterialSymbolsBatteryFull: typeof import('~icons/material-symbols/battery-full')['default']
  const IconMaterialSymbolsPerson: typeof import('~icons/material-symbols/person')['default']
  const IconMaterialSymbolsSignalCellular4Bar: typeof import('~icons/material-symbols/signal-cellular4-bar')['default']
  const IconMaterialSymbolsWifi: typeof import('~icons/material-symbols/wifi')['default']
